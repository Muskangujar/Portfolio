...
const FEATURED_PROJECTS = [
  {
    title: "AgentID",
    description: "Production-ready memory layer for AI agents enabling long-term context and stateful behavior.",
    tags: ["LLMs", "Memory SDK"],
    image: "/agentid.png",
  },
  {
    title: "AgentMem",
    description: "Multi-modal memory system for AI agents featuring a high-performance Rust core.",
    tags: ["Rust", "AI Memory"],
    image: "/agentmem.png",
  },
  {
    title: "Quant Regime Analysis",
    description: "Financial research pipeline utilizing Reinforcement Learning for market regime detection.",
    tags: ["Quant", "Financial ML"],
    image: "/quant.png",
  },
  {
    title: "Autonomous Driving",
    description: "Real-time perception pipeline utilizing YOLOv8 and OpenCV for multi-class object detection.",
    tags: ["YOLOv8", "Edge AI"],
    image: "/driving.png",
  },
  {
    title: "Healthcare Chatbot",
    description: "Medical assistant leveraging Tesseract OCR and ML for automated symptom analysis.",
    tags: ["OCR", "Healthcare AI"],
    image: "/healthcare_v2.png",
  },
  {
    title: "Music Emotion classification",
    description: "CNN-LSTM hybrid model for mapping audio spectral features to emotional moods.",
    tags: ["Deep Learning", "Audio DSP"],
    image: "/music_v2.png",
  },
  {
    title: "Bank Simulation & AI",
    description: "ATM simulator with Streamlit UI and integrated AI assistant.",
    tags: ["Streamlit", "Python"],
    image: "/bank_v2.png",
  },
  {
    title: "Hotel Management System",
    description: "Web-based hotel operations platform built with Flask and MySQL.",
    tags: ["Flask", "MySQL"],
    image: "/hotel_v2.png",
  }
];
